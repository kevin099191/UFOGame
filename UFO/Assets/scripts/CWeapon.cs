...
public class CWeapon : MonoBehaviour
{
    ...
    private void Create()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Keypad1))
        {
            ...
            Instantiate(ufo, point[0].position, Quaternion.identity);
        ...
        if (Input.GetKeyDown(KeyCode.Keypad2))
        {
            ...
            Instantiate(ufo, point[1].position, Quaternion.identity);
        }

        if (Input.GetKeyDown(KeyCode.Keypad3))
        {
            //Instantiate(ufo, point[2].GetComponent<Transform>().position, Quaternion.identity);
            Instantiate(ufo, point[2].position, Quaternion.identity);
        }
